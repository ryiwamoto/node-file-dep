...
var Project = (function(){
  function Project(parser, option){
    option = option || {};
  ...
  Project.prototype.addFile = function(filePath, fileContent){
    ...
    var dependencies = this.parser.parse(fullPath, fileContent);
  ...
  Project.prototype.updateFile = function(filePath, fileContent){
    ...
    var newDependencies = this.parser.parse(fullPath, fileContent);
    newDependencies.forEach(function(dep){
      _this.graph.addDependency(fullPath, _this._toFullPath(dep));
    });
  };

  Project.prototype.getDependantsOf = function(filePath){
    return this.graph.getDependantsOf(this._toFullPath(filePath));
  };
